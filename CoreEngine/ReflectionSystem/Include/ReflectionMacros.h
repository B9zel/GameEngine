...
#define ImplementStaticClass(ClassOfMethod, NewClass, NameSourceClass)                                                                                         \
	...
	{                                                                                                                                                          \
		...
		static bool IsConstruct = false;                                                                                                                       \
		if (StaticClassInstance.expired() && !IsConstruct)                                                                                                     \
		{                                                                                                                                                      \
			IsConstruct = true;                                                                                                                                \
			auto NewMetaClass = MakeSharedPtr<NewClass>();                                                                                                     \
			CoreEngine::Reflection::ReflectionManager::Get()->RegisterNewClass(NameSourceClass, NewMetaClass);                                                 \
			StaticClassInstance = NewMetaClass;                                                                                                                \
			NewMetaClass->Construct();                                                                                                                         \
		}                                                                                                                                                      \
...
#define GenetateHeaderRegistryClass(NameClass, Namespace)                                                                                                      \
	namespace PASTE_DETAILS(Register_namespace_, NameClass)                                                                                                    \
	{                                                                                                                                                          \
...
#define GenetateSourceRegistryClass(NameClass, Namespace)                                                                                                      \
	namespace PASTE_DETAILS(Register_namespace_, NameClass)                                                                                                    \
	{                                                                                                                                                          \
		...
		{                                                                                                                                                      \
			...
			Class.CreateMetaClass = []() -> CoreEngine::Reflection::ConstructionField* { return Namespace::##NameClass::GetStaticClass(); };                   \
